...
def write_config(files: list[Path]) -> None:
    ...
    lines += [
        ...
        "    y: 1",
        "    x: 1",
        # This fixture is generated by run_phase_linking without neighbor_arrays,
        # i.e. the full rectangular window. Declare that explicitly so the Rust
        # side reproduces it rather than picking up dolphin's GLRT config default.
        "  shp_method: rect",
        "output_options:",
        "  strides:",
        "    y: 1",
