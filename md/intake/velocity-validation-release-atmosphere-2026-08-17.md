...
| EO-316 | Close after the pin. | **Deferred — the live issue was reopened with a production-replay acceptance criterion; re-enter only after eo #419/#440 recovery and a fresh `pipeline-verified.sh` receipt proves non-null regression-residual provenance and recomputed confidence** |
